    ...
    def create_draft_examples_by_swagger(self, resources, command, cmd_operation_ids, cmd_name):
        ...
        for resource in resources:
            ...
            if path_item.get is not None and path_item.get.operation_id in cmd_operation_ids:
                example_builder = SwaggerExampleBuilder(command=command, operation=path_item.get, cmd_operation=cmd_operation_ids[path_item.get.operation_id])
                ...
                example_builder = SwaggerExampleBuilder(command=command, operation=path_item.delete, cmd_operation=cmd_operation_ids[path_item.delete.operation_id])
                ...
                example_builder = SwaggerExampleBuilder(command=command, operation=path_item.put, cmd_operation=cmd_operation_ids[path_item.put.operation_id])
                examples = path_item.put.x_ms_examples

            elif path_item.post is not None and path_item.post.operation_id in cmd_operation_ids:
                example_builder = SwaggerExampleBuilder(command=command, operation=path_item.post, cmd_operation=cmd_operation_ids[path_item.post.operation_id])
                ...
                example_builder = SwaggerExampleBuilder(command=command, operation=path_item.head, cmd_operation=cmd_operation_ids[path_item.head.operation_id])
